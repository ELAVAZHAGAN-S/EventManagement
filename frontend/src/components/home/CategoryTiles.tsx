...
const CategoryTiles = () => {
    ...
    return (
        <div className="py-6">
            <div className="flex overflow-x-auto gap-4 p-6 scrollbar-thin scrollbar-thumb-violet-500/30 scrollbar-track-transparent">
                    ...
                    return (
                        ...
                        >
                            <div className="glass-card p-6 w-36 flex flex-col items-center gap-3 
                                transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-amber-100/20
                                ...
                                <span className="text-sm font-semibold text-slate-200 text-center group-hover:text-amber-300 transition-colors">
                                    {category.label}
                                </span>
                            </div>
                        </button>
